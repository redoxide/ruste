...
public interface RustPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXPR_LEAF_FEATURE_COUNT = EXPR_RVALUE_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int EXPR_LESS_THAN_OR_EQUAL_TO = 103;
   ...
   * @generated
   */
  int EXPR_GREATER_THAN_OR_EQUAL_TO = 104;
