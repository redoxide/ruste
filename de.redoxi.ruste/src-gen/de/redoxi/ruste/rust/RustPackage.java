...
public interface RustPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>View Items</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int CRATE__VIEW_ITEMS = 0;
   ...
   * @ordered
   */
  int CRATE_FEATURE_COUNT = 2;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ViewItemImpl <em>View Item</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ViewItemImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getViewItem()
   * @generated
   */
  int VIEW_ITEM = 1;
   ...
   * @ordered
   */
  int VIEW_ITEM_FEATURE_COUNT = 1;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExternModDeclImpl <em>Extern Mod Decl</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExternModDeclImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExternModDecl()
   * @generated
   */
  int EXTERN_MOD_DECL = 2;
   ...
   * @ordered
   */
  int EXTERN_MOD_DECL__NAME = VIEW_ITEM__NAME;
   ...
   * @ordered
   */
  int EXTERN_MOD_DECL__ATTRS = VIEW_ITEM_FEATURE_COUNT + 0;

  /**
   * The feature id for the '<em><b>External Ident</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXTERN_MOD_DECL__EXTERNAL_IDENT = VIEW_ITEM_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Extern Mod Decl</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXTERN_MOD_DECL_FEATURE_COUNT = VIEW_ITEM_FEATURE_COUNT + 2;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.LinkAttrImpl <em>Link Attr</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.LinkAttrImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getLinkAttr()
   * @generated
   */
  int LINK_ATTR = 3;
   ...
   * @ordered
   */
  int LINK_ATTR__VALUE = 1;

  /**
   * The number of structural features of the '<em>Link Attr</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int LINK_ATTR_FEATURE_COUNT = 2;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.UseDeclImpl <em>Use Decl</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.UseDeclImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getUseDecl()
   * @generated
   */
  int USE_DECL = 4;
   ...
   * @ordered
   */
  int USE_DECL__NAME = VIEW_ITEM__NAME;
   ...
   * @ordered
   */
  int USE_DECL__VIS = VIEW_ITEM_FEATURE_COUNT + 0;

  /**
   * The feature id for the '<em><b>Extern Path</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int USE_DECL__EXTERN_PATH = VIEW_ITEM_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int USE_DECL__PATH = VIEW_ITEM_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int USE_DECL_FEATURE_COUNT = VIEW_ITEM_FEATURE_COUNT + 3;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.PathGlobImpl <em>Path Glob</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.PathGlobImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getPathGlob()
   * @generated
   */
  int PATH_GLOB = 5;
   ...
   * @ordered
   */
  int PATH_GLOB__TAIL = 1;

  /**
   * The number of structural features of the '<em>Path Glob</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int PATH_GLOB_FEATURE_COUNT = 2;
   ...
   * @ordered
   */
  int ATTR_WITH_LIST__NAME = ATTR__NAME;
   ...
   * @ordered
   */
  int LITERAL_ATTR__NAME = ATTR__NAME;
   ...
   * @ordered
   */
  int MOD_ITEM__NAME = ITEM_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int MOD_ITEM__VIEW_ITEMS = ITEM_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int MOD_ITEM__ITEMS = ITEM_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int MOD_ITEM_FEATURE_COUNT = ITEM_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int FN_ITEM__NAME = ITEM_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int TYPE_ITEM__NAME = ITEM_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int STRUCT_ITEM__NAME = ITEM_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int ENUM_ITEM__NAME = ITEM_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int TRAIT_ITEM__NAME = ITEM_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int STATIC_ITEM__NAME = ITEM_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_LVALUE_FEATURE_COUNT = 1;
   ...
   * @ordered
   */
  int EXPR_BINARY_FEATURE_COUNT = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int BOOLEAN_OR_FEATURE_COUNT = ASSIGN_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int ADDITION_OR_SUBTRACTION = 46;
   ...
   * @generated
   */
  int DIVISION_MULTIPLICATION_OR_MODULO = 44;
   ...
   * @ordered
   */
  int EXPR_UNARY_FEATURE_COUNT = DIVISION_MULTIPLICATION_OR_MODULO_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprFieldsImpl <em>Expr Fields</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprFieldsImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprFields()
   * @generated
   */
  int EXPR_FIELDS = 41;
   ...
   * @ordered
   */
  int EXPR_FIELDS__EXPRS = EXPR_UNARY_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Expr Fields</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_FIELDS_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_LEAF__EXPRS = EXPR_FIELDS__EXPRS;
   ...
   * @ordered
   */
  int EXPR_LEAF_FEATURE_COUNT = EXPR_FIELDS_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprFnCallArgsImpl <em>Expr Fn Call Args</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprFnCallArgsImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprFnCallArgs()
   * @generated
   */
  int EXPR_FN_CALL_ARGS = 28;
   ...
   * @ordered
   */
  int EXPR_FN_CALL_ARGS__TAIL = 1;

  /**
   * The number of structural features of the '<em>Expr Fn Call Args</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_FN_CALL_ARGS_FEATURE_COUNT = 2;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprPrimaryImpl <em>Expr Primary</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprPrimaryImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprPrimary()
   * @generated
   */
  int EXPR_PRIMARY = 29;
   ...
   * @ordered
   */
  int EXPR_PRIMARY__EXPRS = EXPR_LEAF__EXPRS;
   ...
   * @ordered
   */
  int EXPR_PRIMARY__ARGS = EXPR_LEAF_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Expr Primary</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_PRIMARY_FEATURE_COUNT = EXPR_LEAF_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_LITERAL__EXPRS = EXPR_PRIMARY__EXPRS;
   ...
   * @ordered
   */
  int EXPR_LITERAL__ARGS = EXPR_PRIMARY__ARGS;
   ...
   * @ordered
   */
  int EXPR_LITERAL__LITERAL = EXPR_PRIMARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_LITERAL_FEATURE_COUNT = EXPR_PRIMARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_GROUP__EXPRS = EXPR_PRIMARY__EXPRS;
   ...
   * @ordered
   */
  int EXPR_GROUP__ARGS = EXPR_PRIMARY__ARGS;
   ...
   * @ordered
   */
  int EXPR_GROUP__EXPR = EXPR_PRIMARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_GROUP_FEATURE_COUNT = EXPR_PRIMARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_STRUCT__EXPRS = EXPR_PRIMARY__EXPRS;
   ...
   * @ordered
   */
  int EXPR_STRUCT__ARGS = EXPR_PRIMARY__ARGS;
   ...
   * @ordered
   */
  int EXPR_STRUCT__FIELDS = EXPR_PRIMARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_STRUCT__BASE_EXPR = EXPR_PRIMARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_STRUCT_FEATURE_COUNT = EXPR_PRIMARY_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_VEC__EXPRS = EXPR_PRIMARY__EXPRS;
   ...
   * @ordered
   */
  int EXPR_VEC__ARGS = EXPR_PRIMARY__ARGS;
   ...
   * @ordered
   */
  int EXPR_VEC__MUTABLE = EXPR_PRIMARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_VEC__LEN_EXPR = EXPR_PRIMARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_VEC_FEATURE_COUNT = EXPR_PRIMARY_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int NUMERIC_NEGATION__EXPR = EXPR_UNARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int NUMERIC_NEGATION_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int DEREFERENCE__EXPR = EXPR_UNARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int DEREFERENCE_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int LOGICAL_NEGATION__EXPR = EXPR_UNARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LOGICAL_NEGATION_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int MANAGED_BOX__EXPR = EXPR_UNARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int MANAGED_BOX_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int OWNED_BOX__EXPR = EXPR_UNARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int OWNED_BOX_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int BORROW__EXPR = EXPR_UNARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int BORROW_FEATURE_COUNT = EXPR_UNARY_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprFieldOrMethodCallImpl <em>Expr Field Or Method Call</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprFieldOrMethodCallImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprFieldOrMethodCall()
   * @generated
   */
  int EXPR_FIELD_OR_METHOD_CALL = 42;
   ...
   * @ordered
   */
  int EXPR_FIELD_OR_METHOD_CALL__NAME = 0;
   ...
   * @ordered
   */
  int EXPR_FIELD_OR_METHOD_CALL__ARGS = 1;

  /**
   * The number of structural features of the '<em>Expr Field Or Method Call</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_FIELD_OR_METHOD_CALL_FEATURE_COUNT = 2;
   ...
   * @ordered
   */
  int EXPR_LAMBDA__ARGS = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_LAMBDA__EXPR = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_LAMBDA_FEATURE_COUNT = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_WHILE__EXPR = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_WHILE__BLOCK = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_WHILE_FEATURE_COUNT = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_LOOP__LIFETIME = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_LOOP__BLOCK = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_LOOP_FEATURE_COUNT = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_BREAK__LIFETIME = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_BREAK_FEATURE_COUNT = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_CONTINUE__LIFETIME = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_CONTINUE_FEATURE_COUNT = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_DO__EXPR = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_DO__ARGS = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_DO__BLOCK = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_DO_FEATURE_COUNT = EXPR_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int EXPR_FOR__PAT = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_FOR__EXPR = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_FOR__BLOCK = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_FOR_FEATURE_COUNT = EXPR_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int EXPR_IF__BLOCK = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_IF__EXPR = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_IF__ELSE = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_IF_FEATURE_COUNT = EXPR_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int EXPR_MATCH__EXPR = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_MATCH__ARMS = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_MATCH_FEATURE_COUNT = EXPR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_RETURN__EXPR = EXPR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_RETURN_FEATURE_COUNT = EXPR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int GENERIC_PARAM_DECL__NAME = 0;
   ...
   * @ordered
   */
  int PAT_IDENT__NAME = PAT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_PATH__EXPRS = EXPR_PRIMARY__EXPRS;
   ...
   * @ordered
   */
  int EXPR_PATH__ARGS = EXPR_PRIMARY__ARGS;
   ...
   * @ordered
   */
  int EXPR_PATH__SEGMENTS = EXPR_PRIMARY_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_PATH__LIFETIMES = EXPR_PRIMARY_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_PATH__GENERIC_TYPES = EXPR_PRIMARY_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_PATH_FEATURE_COUNT = EXPR_PRIMARY_FEATURE_COUNT + 3;
  ...
  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.TextualTypeImpl <em>Textual Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.TextualTypeImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getTextualType()
   * @generated
   */
  int TEXTUAL_TYPE = 90;

  /**
   * The number of structural features of the '<em>Textual Type</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int TEXTUAL_TYPE_FEATURE_COUNT = TYPE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int STRUCT_VARIANT__NAME = VARIANT__NAME;
   ...
   * @ordered
   */
  int TUPLE_VARIANT__NAME = VARIANT__NAME;
   ...
   * @ordered
   */
  int UNIT_VARIANT__NAME = VARIANT__NAME;
  ...
  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprFieldImpl <em>Expr Field</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprFieldImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprField()
   * @generated
   */
  int EXPR_FIELD = 104;
   ...
   * @ordered
   */
  int EXPR_FIELD__EXPR = EXPR_LVALUE__EXPR;
   ...
   * @ordered
   */
  int EXPR_FIELD__FIELD = EXPR_LVALUE_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Expr Field</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_FIELD_FEATURE_COUNT = EXPR_LVALUE_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprIndexImpl <em>Expr Index</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprIndexImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprIndex()
   * @generated
   */
  int EXPR_INDEX = 105;
   ...
   * @ordered
   */
  int EXPR_INDEX__EXPR = EXPR_LVALUE__EXPR;
   ...
   * @ordered
   */
  int EXPR_INDEX__INDEX_EXPR = EXPR_LVALUE_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Expr Index</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_INDEX_FEATURE_COUNT = EXPR_LVALUE_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprCallImpl <em>Expr Call</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprCallImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprCall()
   * @generated
   */
  int EXPR_CALL = 106;
   ...
   * @ordered
   */
  int EXPR_CALL__EXPRS = EXPR_LEAF__EXPRS;
   ...
   * @ordered
   */
  int EXPR_CALL__EXPR = EXPR_LEAF_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Expr Call</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_CALL_FEATURE_COUNT = EXPR_LEAF_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_TUPLE__EXPRS = EXPR_GROUP__EXPRS;
   ...
   * @ordered
   */
  int EXPR_TUPLE__ARGS = EXPR_GROUP__ARGS;
   ...
   * @ordered
   */
  int EXPR_TUPLE__EXPR = EXPR_GROUP__EXPR;
   ...
   * @ordered
   */
  int EXPR_TUPLE_FEATURE_COUNT = EXPR_GROUP_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprMultiplicativeImpl <em>Expr Multiplicative</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprMultiplicativeImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprMultiplicative()
   * @generated
   */
  int EXPR_MULTIPLICATIVE = 108;
   ...
   * @ordered
   */
  int EXPR_MULTIPLICATIVE__EXPRS = DIVISION_MULTIPLICATION_OR_MODULO_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_MULTIPLICATIVE__OPS = DIVISION_MULTIPLICATION_OR_MODULO_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Expr Multiplicative</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_MULTIPLICATIVE_FEATURE_COUNT = DIVISION_MULTIPLICATION_OR_MODULO_FEATURE_COUNT + 2;
  ...
  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprAdditiveImpl <em>Expr Additive</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprAdditiveImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprAdditive()
   * @generated
   */
  int EXPR_ADDITIVE = 110;
   ...
   * @ordered
   */
  int EXPR_ADDITIVE__EXPRS = ADDITION_OR_SUBTRACTION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_ADDITIVE__OPS = ADDITION_OR_SUBTRACTION_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_ADDITIVE_FEATURE_COUNT = ADDITION_OR_SUBTRACTION_FEATURE_COUNT + 2;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprShiftImpl <em>Expr Shift</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprShiftImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprShift()
   * @generated
   */
  int EXPR_SHIFT = 111;
   ...
   * @ordered
   */
  int EXPR_SHIFT__EXPRS = SHIFT_OPERATOR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_SHIFT__OPS = SHIFT_OPERATOR_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Expr Shift</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_SHIFT_FEATURE_COUNT = SHIFT_OPERATOR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_BITWISE_AND__EXPRS = BITWISE_AND_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_BITWISE_AND_FEATURE_COUNT = BITWISE_AND_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_BITWISE_XOR__EXPRS = BITWISE_XOR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_BITWISE_XOR_FEATURE_COUNT = BITWISE_XOR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_BITWISE_OR__EXPRS = BITWISE_OR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_BITWISE_OR_FEATURE_COUNT = BITWISE_OR_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprComparisionImpl <em>Expr Comparision</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprComparisionImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprComparision()
   * @generated
   */
  int EXPR_COMPARISION = 115;
   ...
   * @ordered
   */
  int EXPR_COMPARISION__EXPRS = COMPARISON_OPERATORS_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_COMPARISION__OPS = COMPARISON_OPERATORS_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Expr Comparision</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPR_COMPARISION_FEATURE_COUNT = COMPARISON_OPERATORS_FEATURE_COUNT + 2;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.ExprEqualImpl <em>Expr Equal</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.ExprEqualImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprEqual()
   * @generated
   */
  int EXPR_EQUAL = 116;
   ...
   * @ordered
   */
  int EXPR_EQUAL__EXPRS = EQUALITY_OPERATOR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_EQUAL__OPS = EQUALITY_OPERATOR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_EQUAL_FEATURE_COUNT = EQUALITY_OPERATOR_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int EXPR_BOOLEAN_AND__EXPRS = BOOLEAN_AND_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_BOOLEAN_AND_FEATURE_COUNT = BOOLEAN_AND_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_BOOLEAN_OR__EXPRS = BOOLEAN_OR_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_BOOLEAN_OR_FEATURE_COUNT = BOOLEAN_OR_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int EXPR_ASSIGN__EXPRS = ASSIGN_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_ASSIGN_FEATURE_COUNT = ASSIGN_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.CharTypeImpl <em>Char Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.CharTypeImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getCharType()
   * @generated
   */
  int CHAR_TYPE = 127;
   ...
   * @ordered
   */
  int CHAR_TYPE_FEATURE_COUNT = TEXTUAL_TYPE_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.BoxedStrTypeImpl <em>Boxed Str Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.BoxedStrTypeImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getBoxedStrType()
   * @generated
   */
  int BOXED_STR_TYPE = 128;

  /**
   * The number of structural features of the '<em>Boxed Str Type</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int BOXED_STR_TYPE_FEATURE_COUNT = TEXTUAL_TYPE_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.OwnedStrTypeImpl <em>Owned Str Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.OwnedStrTypeImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getOwnedStrType()
   * @generated
   */
  int OWNED_STR_TYPE = 129;

  /**
   * The number of structural features of the '<em>Owned Str Type</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int OWNED_STR_TYPE_FEATURE_COUNT = TEXTUAL_TYPE_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.impl.BorrowedStrTypeImpl <em>Borrowed Str Type</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.impl.BorrowedStrTypeImpl
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getBorrowedStrType()
   * @generated
   */
  int BORROWED_STR_TYPE = 130;

  /**
   * The number of structural features of the '<em>Borrowed Str Type</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int BORROWED_STR_TYPE_FEATURE_COUNT = TEXTUAL_TYPE_FEATURE_COUNT + 0;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.MultiplicativeOp <em>Multiplicative Op</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.MultiplicativeOp
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getMultiplicativeOp()
   * @generated
   */
  int MULTIPLICATIVE_OP = 131;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.AdditiveOp <em>Additive Op</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.AdditiveOp
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getAdditiveOp()
   * @generated
   */
  int ADDITIVE_OP = 132;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.ShiftOp <em>Shift Op</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.ShiftOp
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getShiftOp()
   * @generated
   */
  int SHIFT_OP = 133;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.ComparisonOp <em>Comparison Op</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.ComparisonOp
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getComparisonOp()
   * @generated
   */
  int COMPARISON_OP = 134;

  /**
   * The meta object id for the '{@link de.redoxi.ruste.rust.EqualityOp <em>Equality Op</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.redoxi.ruste.rust.EqualityOp
   * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getEqualityOp()
   * @generated
   */
  int EQUALITY_OP = 135;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.Crate#getViewItems <em>View Items</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>View Items</em>'.
   * @see de.redoxi.ruste.rust.Crate#getViewItems()
   * @see #getCrate()
   * @generated
   */
  EReference getCrate_ViewItems();
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ViewItem <em>View Item</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.ViewItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.ViewItem#getName()
   * @see #getViewItem()
   * @generated
   */
  EAttribute getViewItem_Name();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExternModDecl <em>Extern Mod Decl</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Extern Mod Decl</em>'.
   * @see de.redoxi.ruste.rust.ExternModDecl
   * @generated
   */
  EClass getExternModDecl();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExternModDecl#getAttrs <em>Attrs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Attrs</em>'.
   * @see de.redoxi.ruste.rust.ExternModDecl#getAttrs()
   * @see #getExternModDecl()
   * @generated
   */
  EReference getExternModDecl_Attrs();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ExternModDecl#getExternalIdent <em>External Ident</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>External Ident</em>'.
   * @see de.redoxi.ruste.rust.ExternModDecl#getExternalIdent()
   * @see #getExternModDecl()
   * @generated
   */
  EReference getExternModDecl_ExternalIdent();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.LinkAttr <em>Link Attr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Link Attr</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.LinkAttr#getIdent <em>Ident</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Ident</em>'.
   * @see de.redoxi.ruste.rust.LinkAttr#getIdent()
   * @see #getLinkAttr()
   * @generated
   */
  EAttribute getLinkAttr_Ident();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.LinkAttr#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Value</em>'.
   * @see de.redoxi.ruste.rust.LinkAttr#getValue()
   * @see #getLinkAttr()
   * @generated
   */
  EReference getLinkAttr_Value();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.UseDecl <em>Use Decl</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.UseDecl#getVis <em>Vis</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Vis</em>'.
   * @see de.redoxi.ruste.rust.UseDecl#getVis()
   * @see #getUseDecl()
   * @generated
   */
  EAttribute getUseDecl_Vis();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.UseDecl#getExternPath <em>Extern Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Extern Path</em>'.
   * @see de.redoxi.ruste.rust.UseDecl#getExternPath()
   * @see #getUseDecl()
   * @generated
   */
  EReference getUseDecl_ExternPath();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.UseDecl#getPath <em>Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Path</em>'.
   * @see de.redoxi.ruste.rust.UseDecl#getPath()
   * @see #getUseDecl()
   * @generated
   */
  EReference getUseDecl_Path();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.PathGlob <em>Path Glob</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Path Glob</em>'.
  ...
  /**
   * Returns the meta object for the attribute list '{@link de.redoxi.ruste.rust.PathGlob#getHead <em>Head</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Head</em>'.
   * @see de.redoxi.ruste.rust.PathGlob#getHead()
   * @see #getPathGlob()
   * @generated
   */
  EAttribute getPathGlob_Head();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.PathGlob#getTail <em>Tail</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Tail</em>'.
   * @see de.redoxi.ruste.rust.PathGlob#getTail()
   * @see #getPathGlob()
   * @generated
   */
  EReference getPathGlob_Tail();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.Attr#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.Attr#getName()
   * @see #getAttr()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.ModItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.ModItem#getName()
   * @see #getModItem()
   * @generated
   */
  EAttribute getModItem_Name();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ModItem#getViewItems <em>View Items</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>View Items</em>'.
   * @see de.redoxi.ruste.rust.ModItem#getViewItems()
   * @see #getModItem()
   * @generated
   */
  EReference getModItem_ViewItems();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.FnItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.FnItem#getName()
   * @see #getFnItem()
   * @generated
   */
  EAttribute getFnItem_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.TypeItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.TypeItem#getName()
   * @see #getTypeItem()
   * @generated
   */
  EAttribute getTypeItem_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.StructItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.StructItem#getName()
   * @see #getStructItem()
   * @generated
   */
  EAttribute getStructItem_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.EnumItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.EnumItem#getName()
   * @see #getEnumItem()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.EnumVariant#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.EnumVariant#getName()
   * @see #getEnumVariant()
   * @generated
   */
  EAttribute getEnumVariant_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.TraitItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.TraitItem#getName()
   * @see #getTraitItem()
   * @generated
   */
  EAttribute getTraitItem_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.TraitMethod#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.TraitMethod#getName()
   * @see #getTraitMethod()
   * @generated
   */
  EAttribute getTraitMethod_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.ImplMethod#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.ImplMethod#getName()
   * @see #getImplMethod()
   * @generated
   */
  EAttribute getImplMethod_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.ForeignFn#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.ForeignFn#getName()
   * @see #getForeignFn()
   * @generated
   */
  EAttribute getForeignFn_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.StaticItem#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.StaticItem#getName()
   * @see #getStaticItem()
   * @generated
   */
  EAttribute getStaticItem_Name();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ExprLValue#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.ExprLValue#getExpr()
   * @see #getExprLValue()
   * @generated
   */
  EReference getExprLValue_Expr();
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprFnCallArgs <em>Expr Fn Call Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Fn Call Args</em>'.
   * @see de.redoxi.ruste.rust.ExprFnCallArgs
   * @generated
   */
  EClass getExprFnCallArgs();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprFnCallArgs#getArgs <em>Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Args</em>'.
   * @see de.redoxi.ruste.rust.ExprFnCallArgs#getArgs()
   * @see #getExprFnCallArgs()
   * @generated
   */
  EReference getExprFnCallArgs_Args();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ExprFnCallArgs#getTail <em>Tail</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Tail</em>'.
   * @see de.redoxi.ruste.rust.ExprFnCallArgs#getTail()
   * @see #getExprFnCallArgs()
   * @generated
   */
  EReference getExprFnCallArgs_Tail();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprPrimary <em>Expr Primary</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Primary</em>'.
   * @see de.redoxi.ruste.rust.ExprPrimary
   * @generated
   */
  EClass getExprPrimary();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprPrimary#getArgs <em>Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Args</em>'.
   * @see de.redoxi.ruste.rust.ExprPrimary#getArgs()
   * @see #getExprPrimary()
   * @generated
   */
  EReference getExprPrimary_Args();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.NumericNegation#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.NumericNegation#getExpr()
   * @see #getNumericNegation()
   * @generated
   */
  EReference getNumericNegation_Expr();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.Dereference#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.Dereference#getExpr()
   * @see #getDereference()
   * @generated
   */
  EReference getDereference_Expr();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.LogicalNegation#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.LogicalNegation#getExpr()
   * @see #getLogicalNegation()
   * @generated
   */
  EReference getLogicalNegation_Expr();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ManagedBox#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.ManagedBox#getExpr()
   * @see #getManagedBox()
   * @generated
   */
  EReference getManagedBox_Expr();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.OwnedBox#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.OwnedBox#getExpr()
   * @see #getOwnedBox()
   * @generated
   */
  EReference getOwnedBox_Expr();
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.Borrow#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.Borrow#getExpr()
   * @see #getBorrow()
   * @generated
   */
  EReference getBorrow_Expr();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprFields <em>Expr Fields</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Fields</em>'.
   * @see de.redoxi.ruste.rust.ExprFields
   * @generated
   */
  EClass getExprFields();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprFields#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprFields#getExprs()
   * @see #getExprFields()
   * @generated
   */
  EReference getExprFields_Exprs();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprFieldOrMethodCall <em>Expr Field Or Method Call</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Field Or Method Call</em>'.
   * @see de.redoxi.ruste.rust.ExprFieldOrMethodCall
   * @generated
   */
  EClass getExprFieldOrMethodCall();

  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.ExprFieldOrMethodCall#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.ExprFieldOrMethodCall#getName()
   * @see #getExprFieldOrMethodCall()
   * @generated
   */
  EAttribute getExprFieldOrMethodCall_Name();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ExprFieldOrMethodCall#getArgs <em>Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Args</em>'.
   * @see de.redoxi.ruste.rust.ExprFieldOrMethodCall#getArgs()
   * @see #getExprFieldOrMethodCall()
   * @generated
   */
  EReference getExprFieldOrMethodCall_Args();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.GenericParamDecl#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.GenericParamDecl#getName()
   * @see #getGenericParamDecl()
   * @generated
   */
  EAttribute getGenericParamDecl_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.PatIdent#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.PatIdent#getName()
   * @see #getPatIdent()
   * @generated
   */
  EAttribute getPatIdent_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.FieldPat#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.FieldPat#getName()
   * @see #getFieldPat()
   * @generated
   */
  EAttribute getFieldPat_Name();
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.TextualType <em>Textual Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Textual Type</em>'.
   * @see de.redoxi.ruste.rust.TextualType
   * @generated
   */
  EClass getTextualType();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.StructField#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.StructField#getName()
   * @see #getStructField()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.Variant#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.redoxi.ruste.rust.Variant#getName()
   * @see #getVariant()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprField <em>Expr Field</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Field</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link de.redoxi.ruste.rust.ExprField#getField <em>Field</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Field</em>'.
   * @see de.redoxi.ruste.rust.ExprField#getField()
   * @see #getExprField()
   * @generated
   */
  EAttribute getExprField_Field();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprIndex <em>Expr Index</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Index</em>'.
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ExprIndex#getIndexExpr <em>Index Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Index Expr</em>'.
   * @see de.redoxi.ruste.rust.ExprIndex#getIndexExpr()
   * @see #getExprIndex()
   * @generated
   */
  EReference getExprIndex_IndexExpr();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprCall <em>Expr Call</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Call</em>'.
   * @see de.redoxi.ruste.rust.ExprCall
   * @generated
   */
  EClass getExprCall();

  /**
   * Returns the meta object for the containment reference '{@link de.redoxi.ruste.rust.ExprCall#getExpr <em>Expr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expr</em>'.
   * @see de.redoxi.ruste.rust.ExprCall#getExpr()
   * @see #getExprCall()
   * @generated
   */
  EReference getExprCall_Expr();
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprMultiplicative <em>Expr Multiplicative</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Multiplicative</em>'.
   * @see de.redoxi.ruste.rust.ExprMultiplicative
   * @generated
   */
  EClass getExprMultiplicative();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprMultiplicative#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprMultiplicative#getExprs()
   * @see #getExprMultiplicative()
   * @generated
   */
  EReference getExprMultiplicative_Exprs();

  /**
   * Returns the meta object for the attribute list '{@link de.redoxi.ruste.rust.ExprMultiplicative#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Ops</em>'.
   * @see de.redoxi.ruste.rust.ExprMultiplicative#getOps()
   * @see #getExprMultiplicative()
   * @generated
   */
  EAttribute getExprMultiplicative_Ops();
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprAdditive <em>Expr Additive</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Additive</em>'.
   * @see de.redoxi.ruste.rust.ExprAdditive
   * @generated
   */
  EClass getExprAdditive();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprAdditive#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprAdditive#getExprs()
   * @see #getExprAdditive()
   * @generated
   */
  EReference getExprAdditive_Exprs();

  /**
   * Returns the meta object for the attribute list '{@link de.redoxi.ruste.rust.ExprAdditive#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Ops</em>'.
   * @see de.redoxi.ruste.rust.ExprAdditive#getOps()
   * @see #getExprAdditive()
   * @generated
   */
  EAttribute getExprAdditive_Ops();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprShift <em>Expr Shift</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Shift</em>'.
   * @see de.redoxi.ruste.rust.ExprShift
   * @generated
   */
  EClass getExprShift();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprShift#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprShift#getExprs()
   * @see #getExprShift()
   * @generated
   */
  EReference getExprShift_Exprs();

  /**
   * Returns the meta object for the attribute list '{@link de.redoxi.ruste.rust.ExprShift#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Ops</em>'.
   * @see de.redoxi.ruste.rust.ExprShift#getOps()
   * @see #getExprShift()
   * @generated
   */
  EAttribute getExprShift_Ops();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprBitwiseAnd#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprBitwiseAnd#getExprs()
   * @see #getExprBitwiseAnd()
   * @generated
   */
  EReference getExprBitwiseAnd_Exprs();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprBitwiseXor#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprBitwiseXor#getExprs()
   * @see #getExprBitwiseXor()
   * @generated
   */
  EReference getExprBitwiseXor_Exprs();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprBitwiseOr#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprBitwiseOr#getExprs()
   * @see #getExprBitwiseOr()
   * @generated
   */
  EReference getExprBitwiseOr_Exprs();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprComparision <em>Expr Comparision</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Comparision</em>'.
   * @see de.redoxi.ruste.rust.ExprComparision
   * @generated
   */
  EClass getExprComparision();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprComparision#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprComparision#getExprs()
   * @see #getExprComparision()
   * @generated
   */
  EReference getExprComparision_Exprs();

  /**
   * Returns the meta object for the attribute list '{@link de.redoxi.ruste.rust.ExprComparision#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Ops</em>'.
   * @see de.redoxi.ruste.rust.ExprComparision#getOps()
   * @see #getExprComparision()
   * @generated
   */
  EAttribute getExprComparision_Ops();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.ExprEqual <em>Expr Equal</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Expr Equal</em>'.
   * @see de.redoxi.ruste.rust.ExprEqual
   * @generated
   */
  EClass getExprEqual();

  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprEqual#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprEqual#getExprs()
   * @see #getExprEqual()
   * @generated
   */
  EReference getExprEqual_Exprs();

  /**
   * Returns the meta object for the attribute list '{@link de.redoxi.ruste.rust.ExprEqual#getOps <em>Ops</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Ops</em>'.
   * @see de.redoxi.ruste.rust.ExprEqual#getOps()
   * @see #getExprEqual()
   * @generated
   */
  EAttribute getExprEqual_Ops();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprBooleanAnd#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprBooleanAnd#getExprs()
   * @see #getExprBooleanAnd()
   * @generated
   */
  EReference getExprBooleanAnd_Exprs();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprBooleanOr#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprBooleanOr#getExprs()
   * @see #getExprBooleanOr()
   * @generated
   */
  EReference getExprBooleanOr_Exprs();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link de.redoxi.ruste.rust.ExprAssign#getExprs <em>Exprs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Exprs</em>'.
   * @see de.redoxi.ruste.rust.ExprAssign#getExprs()
   * @see #getExprAssign()
   * @generated
   */
  EReference getExprAssign_Exprs();
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.CharType <em>Char Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.BoxedStrType <em>Boxed Str Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Boxed Str Type</em>'.
   * @see de.redoxi.ruste.rust.BoxedStrType
   * @generated
   */
  EClass getBoxedStrType();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.OwnedStrType <em>Owned Str Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Owned Str Type</em>'.
   * @see de.redoxi.ruste.rust.OwnedStrType
   * @generated
   */
  EClass getOwnedStrType();

  /**
   * Returns the meta object for class '{@link de.redoxi.ruste.rust.BorrowedStrType <em>Borrowed Str Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Borrowed Str Type</em>'.
   * @see de.redoxi.ruste.rust.BorrowedStrType
   * @generated
   */
  EClass getBorrowedStrType();

  /**
   * Returns the meta object for enum '{@link de.redoxi.ruste.rust.MultiplicativeOp <em>Multiplicative Op</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link de.redoxi.ruste.rust.AdditiveOp <em>Additive Op</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link de.redoxi.ruste.rust.ShiftOp <em>Shift Op</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link de.redoxi.ruste.rust.ComparisonOp <em>Comparison Op</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for enum '{@link de.redoxi.ruste.rust.EqualityOp <em>Equality Op</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>View Items</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference CRATE__VIEW_ITEMS = eINSTANCE.getCrate_ViewItems();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ViewItemImpl <em>View Item</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ViewItemImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getViewItem()
     ...
     * @generated
     */
    EAttribute VIEW_ITEM__NAME = eINSTANCE.getViewItem_Name();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExternModDeclImpl <em>Extern Mod Decl</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExternModDeclImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExternModDecl()
     * @generated
     */
    EClass EXTERN_MOD_DECL = eINSTANCE.getExternModDecl();
     ...
     * @generated
     */
    EReference EXTERN_MOD_DECL__ATTRS = eINSTANCE.getExternModDecl_Attrs();

    /**
     * The meta object literal for the '<em><b>External Ident</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference EXTERN_MOD_DECL__EXTERNAL_IDENT = eINSTANCE.getExternModDecl_ExternalIdent();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.LinkAttrImpl <em>Link Attr</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.LinkAttrImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getLinkAttr()
     * @generated
     */
    EClass LINK_ATTR = eINSTANCE.getLinkAttr();
     ...
     * @generated
     */
    EAttribute LINK_ATTR__IDENT = eINSTANCE.getLinkAttr_Ident();
     ...
     * @generated
     */
    EReference LINK_ATTR__VALUE = eINSTANCE.getLinkAttr_Value();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.UseDeclImpl <em>Use Decl</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.UseDeclImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getUseDecl()
     ...
     * @generated
     */
    EAttribute USE_DECL__VIS = eINSTANCE.getUseDecl_Vis();

    /**
     * The meta object literal for the '<em><b>Extern Path</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference USE_DECL__EXTERN_PATH = eINSTANCE.getUseDecl_ExternPath();
     ...
     * @generated
     */
    EReference USE_DECL__PATH = eINSTANCE.getUseDecl_Path();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.PathGlobImpl <em>Path Glob</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.PathGlobImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getPathGlob()
     * @generated
     */
    EClass PATH_GLOB = eINSTANCE.getPathGlob();
     ...
     * @generated
     */
    EAttribute PATH_GLOB__HEAD = eINSTANCE.getPathGlob_Head();
     ...
     * @generated
     */
    EReference PATH_GLOB__TAIL = eINSTANCE.getPathGlob_Tail();
     ...
     * @generated
     */
    EAttribute MOD_ITEM__NAME = eINSTANCE.getModItem_Name();
     ...
     * @generated
     */
    EReference MOD_ITEM__VIEW_ITEMS = eINSTANCE.getModItem_ViewItems();
     ...
     * @generated
     */
    EAttribute FN_ITEM__NAME = eINSTANCE.getFnItem_Name();
     ...
     * @generated
     */
    EAttribute TYPE_ITEM__NAME = eINSTANCE.getTypeItem_Name();
     ...
     * @generated
     */
    EAttribute STRUCT_ITEM__NAME = eINSTANCE.getStructItem_Name();
     ...
     * @generated
     */
    EAttribute ENUM_VARIANT__NAME = eINSTANCE.getEnumVariant_Name();
     ...
     * @generated
     */
    EAttribute TRAIT_ITEM__NAME = eINSTANCE.getTraitItem_Name();
     ...
     * @generated
     */
    EAttribute TRAIT_METHOD__NAME = eINSTANCE.getTraitMethod_Name();
     ...
     * @generated
     */
    EAttribute IMPL_METHOD__NAME = eINSTANCE.getImplMethod_Name();
     ...
     * @generated
     */
    EAttribute FOREIGN_FN__NAME = eINSTANCE.getForeignFn_Name();
     ...
     * @generated
     */
    EAttribute STATIC_ITEM__NAME = eINSTANCE.getStaticItem_Name();
     ...
     * @generated
     */
    EReference EXPR_LVALUE__EXPR = eINSTANCE.getExprLValue_Expr();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprFnCallArgsImpl <em>Expr Fn Call Args</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprFnCallArgsImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprFnCallArgs()
     * @generated
     */
    EClass EXPR_FN_CALL_ARGS = eINSTANCE.getExprFnCallArgs();
     ...
     * @generated
     */
    EReference EXPR_FN_CALL_ARGS__ARGS = eINSTANCE.getExprFnCallArgs_Args();
     ...
     * @generated
     */
    EReference EXPR_FN_CALL_ARGS__TAIL = eINSTANCE.getExprFnCallArgs_Tail();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprPrimaryImpl <em>Expr Primary</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprPrimaryImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprPrimary()
     * @generated
     */
    EClass EXPR_PRIMARY = eINSTANCE.getExprPrimary();
     ...
     * @generated
     */
    EReference EXPR_PRIMARY__ARGS = eINSTANCE.getExprPrimary_Args();
     ...
     * @generated
     */
    EReference NUMERIC_NEGATION__EXPR = eINSTANCE.getNumericNegation_Expr();
     ...
     * @generated
     */
    EReference DEREFERENCE__EXPR = eINSTANCE.getDereference_Expr();
     ...
     * @generated
     */
    EReference LOGICAL_NEGATION__EXPR = eINSTANCE.getLogicalNegation_Expr();
     ...
     * @generated
     */
    EReference MANAGED_BOX__EXPR = eINSTANCE.getManagedBox_Expr();
     ...
     * @generated
     */
    EReference OWNED_BOX__EXPR = eINSTANCE.getOwnedBox_Expr();
     ...
     * @generated
     */
    EReference BORROW__EXPR = eINSTANCE.getBorrow_Expr();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprFieldsImpl <em>Expr Fields</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprFieldsImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprFields()
     * @generated
     */
    EClass EXPR_FIELDS = eINSTANCE.getExprFields();
     ...
     * @generated
     */
    EReference EXPR_FIELDS__EXPRS = eINSTANCE.getExprFields_Exprs();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprFieldOrMethodCallImpl <em>Expr Field Or Method Call</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprFieldOrMethodCallImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprFieldOrMethodCall()
     * @generated
     */
    EClass EXPR_FIELD_OR_METHOD_CALL = eINSTANCE.getExprFieldOrMethodCall();
     ...
     * @generated
     */
    EAttribute EXPR_FIELD_OR_METHOD_CALL__NAME = eINSTANCE.getExprFieldOrMethodCall_Name();
     ...
     * @generated
     */
    EReference EXPR_FIELD_OR_METHOD_CALL__ARGS = eINSTANCE.getExprFieldOrMethodCall_Args();
     ...
     * @generated
     */
    EAttribute GENERIC_PARAM_DECL__NAME = eINSTANCE.getGenericParamDecl_Name();
     ...
     * @generated
     */
    EAttribute PAT_IDENT__NAME = eINSTANCE.getPatIdent_Name();
     ...
     * @generated
     */
    EAttribute FIELD_PAT__NAME = eINSTANCE.getFieldPat_Name();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.TextualTypeImpl <em>Textual Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.TextualTypeImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getTextualType()
     * @generated
     */
    EClass TEXTUAL_TYPE = eINSTANCE.getTextualType();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprFieldImpl <em>Expr Field</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprFieldImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprField()
     * @generated
     */
    EClass EXPR_FIELD = eINSTANCE.getExprField();
     ...
     * @generated
     */
    EAttribute EXPR_FIELD__FIELD = eINSTANCE.getExprField_Field();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprIndexImpl <em>Expr Index</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprIndexImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprIndex()
     * @generated
     */
    EClass EXPR_INDEX = eINSTANCE.getExprIndex();
     ...
     * @generated
     */
    EReference EXPR_INDEX__INDEX_EXPR = eINSTANCE.getExprIndex_IndexExpr();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprCallImpl <em>Expr Call</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprCallImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprCall()
     * @generated
     */
    EClass EXPR_CALL = eINSTANCE.getExprCall();
     ...
     * @generated
     */
    EReference EXPR_CALL__EXPR = eINSTANCE.getExprCall_Expr();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprMultiplicativeImpl <em>Expr Multiplicative</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprMultiplicativeImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprMultiplicative()
     * @generated
     */
    EClass EXPR_MULTIPLICATIVE = eINSTANCE.getExprMultiplicative();
     ...
     * @generated
     */
    EReference EXPR_MULTIPLICATIVE__EXPRS = eINSTANCE.getExprMultiplicative_Exprs();
     ...
     * @generated
     */
    EAttribute EXPR_MULTIPLICATIVE__OPS = eINSTANCE.getExprMultiplicative_Ops();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprAdditiveImpl <em>Expr Additive</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprAdditiveImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprAdditive()
     ...
     * @generated
     */
    EReference EXPR_ADDITIVE__EXPRS = eINSTANCE.getExprAdditive_Exprs();
     ...
     * @generated
     */
    EAttribute EXPR_ADDITIVE__OPS = eINSTANCE.getExprAdditive_Ops();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprShiftImpl <em>Expr Shift</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprShiftImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprShift()
     * @generated
     */
    EClass EXPR_SHIFT = eINSTANCE.getExprShift();
     ...
     * @generated
     */
    EReference EXPR_SHIFT__EXPRS = eINSTANCE.getExprShift_Exprs();
     ...
     * @generated
     */
    EAttribute EXPR_SHIFT__OPS = eINSTANCE.getExprShift_Ops();
     ...
     * @generated
     */
    EReference EXPR_BITWISE_AND__EXPRS = eINSTANCE.getExprBitwiseAnd_Exprs();
     ...
     * @generated
     */
    EReference EXPR_BITWISE_XOR__EXPRS = eINSTANCE.getExprBitwiseXor_Exprs();
     ...
     * @generated
     */
    EReference EXPR_BITWISE_OR__EXPRS = eINSTANCE.getExprBitwiseOr_Exprs();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprComparisionImpl <em>Expr Comparision</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprComparisionImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprComparision()
     * @generated
     */
    EClass EXPR_COMPARISION = eINSTANCE.getExprComparision();
     ...
     * @generated
     */
    EReference EXPR_COMPARISION__EXPRS = eINSTANCE.getExprComparision_Exprs();
     ...
     * @generated
     */
    EAttribute EXPR_COMPARISION__OPS = eINSTANCE.getExprComparision_Ops();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.ExprEqualImpl <em>Expr Equal</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.ExprEqualImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getExprEqual()
     ...
     * @generated
     */
    EReference EXPR_EQUAL__EXPRS = eINSTANCE.getExprEqual_Exprs();
     ...
     * @generated
     */
    EAttribute EXPR_EQUAL__OPS = eINSTANCE.getExprEqual_Ops();
     ...
     * @generated
     */
    EReference EXPR_BOOLEAN_AND__EXPRS = eINSTANCE.getExprBooleanAnd_Exprs();
     ...
     * @generated
     */
    EReference EXPR_BOOLEAN_OR__EXPRS = eINSTANCE.getExprBooleanOr_Exprs();
     ...
     * @generated
     */
    EReference EXPR_ASSIGN__EXPRS = eINSTANCE.getExprAssign_Exprs();
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.CharTypeImpl <em>Char Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.CharTypeImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getCharType()
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.BoxedStrTypeImpl <em>Boxed Str Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.BoxedStrTypeImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getBoxedStrType()
     * @generated
     */
    EClass BOXED_STR_TYPE = eINSTANCE.getBoxedStrType();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.OwnedStrTypeImpl <em>Owned Str Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.OwnedStrTypeImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getOwnedStrType()
     * @generated
     */
    EClass OWNED_STR_TYPE = eINSTANCE.getOwnedStrType();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.impl.BorrowedStrTypeImpl <em>Borrowed Str Type</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.impl.BorrowedStrTypeImpl
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getBorrowedStrType()
     * @generated
     */
    EClass BORROWED_STR_TYPE = eINSTANCE.getBorrowedStrType();

    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.MultiplicativeOp <em>Multiplicative Op</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.MultiplicativeOp
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getMultiplicativeOp()
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.AdditiveOp <em>Additive Op</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.AdditiveOp
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getAdditiveOp()
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.ShiftOp <em>Shift Op</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.ShiftOp
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getShiftOp()
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.ComparisonOp <em>Comparison Op</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.ComparisonOp
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getComparisonOp()
    ...
    /**
     * The meta object literal for the '{@link de.redoxi.ruste.rust.EqualityOp <em>Equality Op</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.redoxi.ruste.rust.EqualityOp
     * @see de.redoxi.ruste.rust.impl.RustPackageImpl#getEqualityOp()
     * @generated
     */
    EEnum EQUALITY_OP = eINSTANCE.getEqualityOp();
