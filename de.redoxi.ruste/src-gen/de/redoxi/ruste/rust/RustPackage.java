...
public interface RustPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXPR_TUPLE__EXPRS = EXPR_RVALUE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXPR_TUPLE_FEATURE_COUNT = EXPR_RVALUE_FEATURE_COUNT + 1;
