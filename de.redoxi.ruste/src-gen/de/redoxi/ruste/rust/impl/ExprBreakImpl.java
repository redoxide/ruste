...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Expr Break</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.redoxi.ruste.rust.impl.ExprBreakImpl#getLifetime <em>Lifetime</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExprBreakImpl extends ExprLeafImpl implements ExprBreak
{
  ...
  {
    return RustPackage.Literals.EXPR_BREAK;
  }
  ...
  public void setLifetime(String newLifetime)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RustPackage.EXPR_BREAK__LIFETIME, oldLifetime, lifetime));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RustPackage.EXPR_BREAK__LIFETIME:
        return getLifetime();
    }
