		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExprLeafAccess().getAlternatives_1(), "rule__ExprLeaf__Alternatives_1");
					...
					put(grammarAccess.getMultiplicativeOpAccess().getAlternatives(), "rule__MultiplicativeOp__Alternatives");
					put(grammarAccess.getAdditiveOpAccess().getAlternatives(), "rule__AdditiveOp__Alternatives");
					...
					put(grammarAccess.getEqualityOpAccess().getAlternatives(), "rule__EqualityOp__Alternatives");
					...
					put(grammarAccess.getExprLeafAccess().getGroup(), "rule__ExprLeaf__Group__0");
					put(grammarAccess.getExprLeafAccess().getGroup_1_0(), "rule__ExprLeaf__Group_1_0__0");
					put(grammarAccess.getExprLeafAccess().getGroup_1_1(), "rule__ExprLeaf__Group_1_1__0");
					put(grammarAccess.getExprLeafAccess().getGroup_1_1_4(), "rule__ExprLeaf__Group_1_1_4__0");
					...
					put(grammarAccess.getExprFieldsAccess().getGroup(), "rule__ExprFields__Group__0");
					put(grammarAccess.getExprFieldsAccess().getGroup_1(), "rule__ExprFields__Group_1__0");
					put(grammarAccess.getExprFieldOrMethodCallAccess().getGroup(), "rule__ExprFieldOrMethodCall__Group__0");
					...
					put(grammarAccess.getAdditionOrSubtractionAccess().getGroup_1_3(), "rule__AdditionOrSubtraction__Group_1_3__0");
					...
					put(grammarAccess.getExprLeafAccess().getArgsAssignment_1_1_2(), "rule__ExprLeaf__ArgsAssignment_1_1_2");
					put(grammarAccess.getExprLeafAccess().getArgsAssignment_1_1_4_2(), "rule__ExprLeaf__ArgsAssignment_1_1_4_2");
					...
					put(grammarAccess.getExprFieldsAccess().getExprsAssignment_1_2(), "rule__ExprFields__ExprsAssignment_1_2");
					put(grammarAccess.getExprFieldOrMethodCallAccess().getNameAssignment_0(), "rule__ExprFieldOrMethodCall__NameAssignment_0");
					put(grammarAccess.getExprFieldOrMethodCallAccess().getArgsAssignment_1(), "rule__ExprFieldOrMethodCall__ArgsAssignment_1");
					put(grammarAccess.getDivisionMultiplicationOrModuloAccess().getOpsAssignment_1_1(), "rule__DivisionMultiplicationOrModulo__OpsAssignment_1_1");
					put(grammarAccess.getDivisionMultiplicationOrModuloAccess().getExprsAssignment_1_2(), "rule__DivisionMultiplicationOrModulo__ExprsAssignment_1_2");
					put(grammarAccess.getAsAccess().getTypeAssignment_1_2(), "rule__As__TypeAssignment_1_2");
					put(grammarAccess.getAdditionOrSubtractionAccess().getOpsAssignment_1_1(), "rule__AdditionOrSubtraction__OpsAssignment_1_1");
					put(grammarAccess.getAdditionOrSubtractionAccess().getExprsAssignment_1_2(), "rule__AdditionOrSubtraction__ExprsAssignment_1_2");
					put(grammarAccess.getAdditionOrSubtractionAccess().getOpsAssignment_1_3_0(), "rule__AdditionOrSubtraction__OpsAssignment_1_3_0");
					put(grammarAccess.getAdditionOrSubtractionAccess().getExprsAssignment_1_3_1(), "rule__AdditionOrSubtraction__ExprsAssignment_1_3_1");
					put(grammarAccess.getShiftOperatorAccess().getOpsAssignment_1_1(), "rule__ShiftOperator__OpsAssignment_1_1");
					put(grammarAccess.getShiftOperatorAccess().getExprsAssignment_1_2(), "rule__ShiftOperator__ExprsAssignment_1_2");
					put(grammarAccess.getBitwiseAndAccess().getExprsAssignment_1_2(), "rule__BitwiseAnd__ExprsAssignment_1_2");
					put(grammarAccess.getBitwiseXorAccess().getExprsAssignment_1_2(), "rule__BitwiseXor__ExprsAssignment_1_2");
					put(grammarAccess.getBitwiseOrAccess().getExprsAssignment_1_2(), "rule__BitwiseOr__ExprsAssignment_1_2");
					put(grammarAccess.getComparisonOperatorsAccess().getOpsAssignment_1_1(), "rule__ComparisonOperators__OpsAssignment_1_1");
					put(grammarAccess.getComparisonOperatorsAccess().getExprsAssignment_1_2(), "rule__ComparisonOperators__ExprsAssignment_1_2");
					put(grammarAccess.getEqualityOperatorAccess().getOpsAssignment_1_1(), "rule__EqualityOperator__OpsAssignment_1_1");
					put(grammarAccess.getEqualityOperatorAccess().getExprsAssignment_1_2(), "rule__EqualityOperator__ExprsAssignment_1_2");
					put(grammarAccess.getBooleanAndAccess().getExprsAssignment_1_2(), "rule__BooleanAnd__ExprsAssignment_1_2");
					put(grammarAccess.getBooleanOrAccess().getExprsAssignment_1_2(), "rule__BooleanOr__ExprsAssignment_1_2");
					put(grammarAccess.getAssignAccess().getExprsAssignment_1_2(), "rule__Assign__ExprsAssignment_1_2");
