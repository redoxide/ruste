		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPatEnumAccess().getAlternatives_2(), "rule__PatEnum__Alternatives_2");
					...
					put(grammarAccess.getPatEnumAccess().getGroup_2_2(), "rule__PatEnum__Group_2_2__0");
					put(grammarAccess.getPatEnumAccess().getGroup_2_2_1(), "rule__PatEnum__Group_2_2_1__0");
					...
					put(grammarAccess.getPatEnumAccess().getPatternsAssignment_2_2_0(), "rule__PatEnum__PatternsAssignment_2_2_0");
					put(grammarAccess.getPatEnumAccess().getPatternsAssignment_2_2_1_1(), "rule__PatEnum__PatternsAssignment_2_2_1_1");
